...
public class staff extends javax.swing.JFrame {
   ...
   dl.setText(s.format(d));
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 110, 230, 690));
        ...
        LA.setFont(new java.awt.Font("Dialog", 0, 24)); // NOI18N
        ...
        PA.setFont(new java.awt.Font("Dialog", 0, 24)); // NOI18N
        ...
        LS.setFont(new java.awt.Font("Dialog", 3, 24)); // NOI18N
        LS.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ON TIME", "BEHIND" }));
        ...
        TP.setFont(new java.awt.Font("Dialog", 0, 24)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(PA, javax.swing.GroupLayout.DEFAULT_SIZE, 620, Short.MAX_VALUE)
                        ...
                        .addContainerGap())
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(LS, javax.swing.GroupLayout.PREFERRED_SIZE, 172, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel7)
                    .addComponent(LA, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(37, 37, 37)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel9)
                    .addComponent(PA, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(42, 42, 42)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel10)
                    .addComponent(TP))
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(EMAIL, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 110, 1000, 690));
        ...
        try
        {
            ...
            while(rs.next())
            {
                if(sid == rs.getInt("id"))
                {
                    ...
                    LA.setText(String.format("%s",rs.getInt("TLA")));
                    PA.setText(String.format("%s",rs.getInt("da")));
                    TP.setText(String.format("%s",rs.getInt("TP")));
                    CONTACT.setText(String.format("%s",rs.getInt("contact")));
                    LS.setSelectedItem(rs.getString("ls"));
    ...
    private void ADDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ADDActionPerformed
        ...
        try
        {
            ...
            int tla  = Integer.parseInt(LA.getText());
            int slp  = Integer.parseInt(PA.getText());
            int stp = Integer.parseInt(TP.getText());
            String sls =(String)LS.getSelectedItem();
            int scontact = Integer.parseInt(CONTACT.getText());
            String saddress = (ADDRESS.getText());
            String email = (EMAIL.getText());

            String query ="INSERT INTO member(id, name, address, TLA, da, TP,  ls, contact, EMAIL ) VALUES(?, ?, ?,  ?, ?, ?, ?, ?, ?)";
            PreparedStatement PreparedStmt = con.prepareStatement(query);
            PreparedStmt.setInt(1, sid);
            PreparedStmt.setString(2, sname);
            PreparedStmt.setString(3, saddress);
            PreparedStmt.setInt(4, tla);
            PreparedStmt.setInt(5, slp);
           PreparedStmt.setInt(6, stp);
            PreparedStmt.setString(7,sls);
    ...
    private void DELETEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DELETEActionPerformed
        ...
        try
        {
            ...
            int sid = Integer.parseInt(ID.getText());
            String query = "DELETE FROM  member WHERE id ='"+sid+"'";
    ...
    private void UPDATEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UPDATEActionPerformed
        ...
        try
        {
            ...
            String query = "UPDATE member SET name = ?, address = ?, TLA = ?, da = ?, TP = ?, ls = ?, contact = ?, EMAIL = ? WHERE id = ? ";
            PreparedStatement PreparedStmt = con.prepareStatement(query);

            
            PreparedStmt.setString(1, sname);
            PreparedStmt.setString(2, saddress);
            PreparedStmt.setInt(3, tla);
            PreparedStmt.setInt(4, slp);
            PreparedStmt.setInt(5, stp);
            PreparedStmt.setString(6,sls);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        int[] R = new int[5];
           R[0]  = Integer.parseInt(LA.getText());
           R[1]  = Integer.parseInt(PA.getText());
           
           R[2] = (R[0]-R[1]);
           
           String def = String.format("%s", R[2]);
           TP.setText(def);
